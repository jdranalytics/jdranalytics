...
Hola, mi nombre es **José Daniel Rojas**, soy un ingeniero químico apasionado de la **analítica, ciencia de datos y sobre todo dar soluciones que generen valor**. Este es mi rincón en GitHub, donde experimento, aprendo y comparto proyectos llevados a cabo con el fin de generar valor.
